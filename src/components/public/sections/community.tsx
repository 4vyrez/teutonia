...
export function CommunitySection() {
    return (
        <section id="community" className="py-32 bg-black text-white border-t border-white/5">
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
                    <div>
                        <span className="text-amber-500 font-mono text-sm tracking-widest uppercase mb-4 block">Gemeinschaft</span>
                    ...
                    {pillars.map((pillar, i) => (
                        <Link href={pillar.href} key={i} className="group">
                            <motion.div
                                ...
                                className="h-full p-8 rounded-3xl bg-[#0A0A0A] border border-white/5 group-hover:border-white/20 transition-colors relative overflow-hidden"
                            >
