      ...
      <div className="rounded-[2.2rem] border border-white/70 bg-white/78 p-6 shadow-[0_40px_120px_rgba(98,72,46,0.1)] backdrop-blur md:p-8 lg:p-10">
        <div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr]">
          ...
          <div className="relative pl-6 md:pl-10">
            <div className="absolute bottom-0 left-0 top-0 w-px bg-[linear-gradient(180deg,rgba(122,47,43,0),rgba(122,47,43,0.75),rgba(122,47,43,0))]" />
            <div className="space-y-6">
              {historyTimeline.map((event, index) => (
                ...
                >
                  <div className="absolute left-[-2rem] top-7 h-4 w-4 rounded-full border-4 border-[#f8f3eb] bg-primary shadow-[0_0_0_8px_rgba(122,47,43,0.08)]" />
